...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default=f'{code_dir}/../results/', help='Path to save results.')
    ...
    if args.single_onnx:
        ...
        print(f"Single ONNX exported to {args.save_path}/{args.single_onnx_name}")
    else:
